  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <div
        ...
        className={cn(
          "group/sidebar-wrapper flex min-h-svh w-full bg-[#0B0F14]",
          className
        )}
        {...props}
      >
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="w-(--sidebar-width) border-r border-white/10 bg-[#0B0F14] p-0 text-sidebar-foreground [&>button]:hidden"
          style={
            {
    ...
    >
      ...
      >
        <div
          ...
          className="flex size-full flex-col border border-white/10 bg-[#0B0F14]/95 shadow-2xl shadow-black/20 backdrop-blur-xl group-data-[variant=floating]:rounded-2xl group-data-[variant=inset]:rounded-2xl group-data-[variant=floating]:ring-1 group-data-[variant=floating]:ring-white/10"
        >
          {children}
        </div>
      </div>
